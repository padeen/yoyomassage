<div class="container max-w-2xl">
	<div class="mx-7 md:mx-0">
		...
		<a href="/massages">
			<div class="relative my-2 bg-pink-500">
				<img
					src="https://firebasestorage.googleapis.com/v0/b/svelte-starter-8ef85.appspot.com/o/images%2Fbeauty-spa_opt.jpg?alt=media&token=b38a276d-ead9-40f5-9eaa-4033fa3a0a1f"
				...
				<p class="photo-caption my-2.5 pb-5 text-slate-50">Massages</p>
			</div>
		</a>
		<a href="/beauty">
			<div class="relative my-2 bg-pink-500">
				<img
					...
					alt="wellness massage"
				/>
				<p class="photo-caption my-2.5 pb-5 text-stone-50">Beauty</p>
			</div>
		</a>
		<a href="/pedicure">
			<div class="relative my-2 bg-pink-500">
				<img
					...
					alt="wellness massage"
				/>
				<p class="photo-caption my-2.5 pb-5 text-white">Pedicure</p>
			</div>
		</a>
		<p class="mt-5 mb-5">
			Laat u verwennen, ontspan en voel u herboren bij ons. Wij kijken ernaar uit om u te
			verwelkomen in onze beauty massagesalon.
		</p>
	</div>
	<div class="bg-pink-500 py-3.5">
		<a href="tel:0687109280">
			<p
				class="header-text mb-0 mb-3 bg-pink-500 text-center text-2xl font-semibold uppercase text-white"
			>
				Maak afspraak
			</p>
			<div class="bg-pink-500 text-center">
				<img class="mx-auto my-3.5 h-8" src="/images/phone-call-white.svg" alt="bellen" />
				<span class="ml-0.5 text-2xl font-bold text-white">06-87109280</span>
			</div>
		</a>
	</div>
</div>
